...
--
-- Data for Name: api_active_odds; Type: TABLE DATA; Schema: public; Owner: site
--

COPY public.api_active_odds (id, datetime, bookmaker, full_time_result, draw_no_bet, both_teams_to_score, double_chance, under_over, event_id) FROM stdin;
\.


--
-- Data for Name: api_all_odds; Type: TABLE DATA; Schema: public; Owner: site
--

COPY public.api_all_odds (id, datetime, bookmaker, full_time_result, draw_no_bet, both_teams_to_score, double_chance, under_over, event_id) FROM stdin;
\.


--
-- Data for Name: api_events; Type: TABLE DATA; Schema: public; Owner: site
--

COPY public.api_events (id, datetime, country, league, home_team, away_team, home_goals, away_goals) FROM stdin;
\.


--
-- Name: api_active_odds_id_seq; Type: SEQUENCE SET; Schema: public; Owner: site
--

SELECT pg_catalog.setval('public.api_active_odds_id_seq', 185, true);


--
-- Name: api_all_odds_id_seq; Type: SEQUENCE SET; Schema: public; Owner: site
--

SELECT pg_catalog.setval('public.api_all_odds_id_seq', 434, true);


--
-- Name: api_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: site
--

SELECT pg_catalog.setval('public.api_events_id_seq', 123, true);
